  ...
  async getAllHedgehogs(): Promise<IHedgehog[]> {
    return [
      ...
      },
      {
        ...
        when: '2018.01.27',
        url:
          'https://res.cloudinary.com/zinovik/image/upload/v1557849331/hedgehogs/2018.01.27_051_Vilnius._Vitalik.jpg',
      },
      {
        where: ['Bukovel', 'Буковель'],
        who: 'Lena',
      ...
      },
      {
        ...
        when: '2018.10.16',
        url:
          'https://res.cloudinary.com/zinovik/image/upload/v1557849332/hedgehogs/2018.10.16_056_Harelbeke._Artur.jpg',
      },
      {
        where: ['Riga', 'Рига'],
        who: 'Lena',
